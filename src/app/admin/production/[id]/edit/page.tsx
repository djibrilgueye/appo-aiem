...
export default function EditProductionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`/api/production/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify(form) })
  ...
  return (
    <div>
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold text-[#0D2840]">Edit Production Record</h1>
        </div>
