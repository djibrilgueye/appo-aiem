  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-[#0D2840]">{t.admin.petrochem.editTitle}</h1>
      </div>
      <form onSubmit={handleSubmit} className="bg-white border border-[#D0E4F0] rounded-xl p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-[#1B4F72] text-sm mb-1">{t.admin.petrochem.capacity}</label>
        ...
        <div>
          <label className="block text-[#1B4F72] text-sm mb-1">Produits <span className="text-[#A3C4DC] text-xs">{t.admin.petrochem.productsHintShort}</span></label>
